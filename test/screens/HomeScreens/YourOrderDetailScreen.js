...
const YourOrderDetailScreen = ({navigation}) => {
  ...
  return (
    <ScrollView style={styles.container}>
          <View style={{height:50, flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginLeft:8, marginRight:5}}>
            <Text style={{fontSize:16, color: '#666666'}}>Tracking order</Text>
            <Text style={{fontSize:14, color: '#FD8209',}} onPress={()=>navigation.navigate('Your Order Detail Delivery Status Screen')}>Detail</Text>
          </View>
      ...
      <View>
        <View style={{height:50, justifyContent:'center', marginLeft:8}}><Text style={{fontSize:16, color: '#666666'}}>Receiver</Text></View>
        <View style={{paddingLeft:15, backgroundColor:'#ffff'}}>
          <View>
            <Text style={{fontSize:14, color: '#000000', paddingBottom:8}}>Bui Gia Hoa</Text>
            <Text style={{fontSize:14, color: '#000000', paddingBottom:8}}>0902733275</Text>
            <Text style={{fontSize:11, color: '#666666', paddingBottom:5}}>20 Le Truc, Ward 7, Binh Thanh District, Ho Chi Minh</Text>
          </View>
        </View>
      </View>

      <View>
        <View style={{height:50, justifyContent:'center', marginLeft:8}}><Text style={{fontSize:16, color: '#666666'}}>Items</Text></View>
      ...
      <View>
        ...
        <View style={{paddingLeft:15, backgroundColor:'#ffff'}}>
          <View>
            <Text style={{fontSize:14, color: '#000000', paddingBottom:8}}>Delivery time: all days long</Text>
            <Text style={{fontSize:14, color: '#000000', paddingBottom:8}}>Delivery date: 30/12/2020 - 5/1/2021</Text>
            <Text style={{fontSize:14, color: '#000000', paddingBottom:8}}>Note: don't knock the door.</Text>
            <Text style={{fontSize:14, color: '#000000', paddingBottom:8}}>Total price: 135.000 VND</Text>
          </View>
        </View>
      </View>
